...
const ThemeSwitcher = () => {
    ...
    return (
        <div className="flex justify-center rounded-md gap-2 p-1 w-fit border border-[#636167]">
            ...
            >
                <Image src="/ThemeSwitcher/sun.png" width={20} height={20} alt="sun icon" />
            </button>
            <button
                className={`p-1 rounded-full ${
            ...
            >
                <Image src="/ThemeSwitcher/home.png" width={20} height={20} alt="home icon" />
            </button>
            <button
                className={`p-1 rounded-full ${
            ...
            >
                <Image src="/ThemeSwitcher/moon.png" width={20} height={20} alt="moon icon" />
            </button>
        </div>
    );
};
